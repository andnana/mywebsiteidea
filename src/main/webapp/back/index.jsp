			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<c:if test="${pageInfo.hasPreviousPage}">
						...
						<li>
							<a href="${ctx}/index?pageNumber=${pageInfo.pageNum - 1}" aria-label="Previous">
					...
					<c:forEach items="${pageInfo.navigatepageNums}" var="pageNum" >
						<c:choose>
							...
							<c:otherwise>
								<li><a href="${ctx}/index?pageNumber=${pageNum}">${pageNum}</a></li>
							</c:otherwise>
						</c:choose>
                    ...
                    <c:if test="${pageInfo.hasNextPage}">
						<li>
							<a href="${ctx}/index?pageNumber=${pageInfo.pageNum + 1}" aria-label="Next">
								<span aria-hidden="true">&raquo;</span>
							</a>
						</li>
						<li><a href="${ctx}/index?pageNumber=${pageInfo.pages}">末页</a></li>
					</c:if>
